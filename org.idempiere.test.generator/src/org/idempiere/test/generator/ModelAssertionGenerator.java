...
public class ModelAssertionGenerator
{
	...
	public ModelAssertionGenerator (int AD_Table_ID, String directory, String modelPackage, String assertionPackage)
	{
		...
		writeToFile (sb, directory + assertionClassName + ".java");
	...
	private String createHeader (int AD_Table_ID, StringBuilder sb, String packageName)
	{
		...
		StringBuilder start = new StringBuilder()
			...
			.append ("/** Generated Assertion Class - DO NOT CHANGE */").append(NL)
		...
		start.append("/** Generated assertion class for ").append(tableName).append(NL)
			...
			//	Standard Constructor
			 ...
			 .append("    public ").append(assertionClassName).append(" (").append(className).append(" actual)").append(NL)
			 .append("    {").append(NL)
			 .append("      super (actual, ").append(assertionClassName).append(".class);").append(NL)
		...
		int AD_Table_ID)
	{
		...
		{
			sb
			.append("\tpublic ").append(assertionClassName).append(" has").append(columnName).append("(int expected)").append(NL)
			.append("\t{").append(NL)
			...
			sb
			.append("\tpublic ").append(assertionClassName).append(" is").append(baseField).append("()").append(NL)
			.append("\t{").append(NL)
			.append("\t\tisNotNull();").append(NL)
			.append("\t\tif (!actual.is").append(baseField).append("()) {").append(NL)
			.append("\t\t\tfailWithMessage(\"\\nExpecting PO:\\n  <%s>\\nto be ").append(baseField).append("\\nbut it was not\",").append(NL)
			.append("\t\t\t\tgetPODescription());").append(NL)
			.append("\t\t}").append(NL)
			.append("\t\treturn myself;").append(NL)
			/**/
			.append("\t}").append(NL)
			.append(NL)
			.append("\tpublic ").append(assertionClassName).append(" isNot").append(baseField).append("()").append(NL)
			.append("\t{").append(NL)
			.append("\t\tisNotNull();").append(NL)
			.append("\t\tif (actual.is").append(baseField).append("()) {").append(NL)
			.append("\t\t\tfailWithMessage(\"\\nExpecting PO: \\n  <%s>\\n to not be ").append(baseField).append("\\nbut it was\",").append(NL)
			.append("\t\t\t\tgetPODescription());").append(NL)
			.append("\t\t}").append(NL)
			.append("\t\treturn myself;").append(NL)
			/**/
		...
		{
			sb
			.append("\tpublic ").append(assertionClassName).append(" has").append(columnName).append("(Object expected)").append(NL)
			.append("\t{").append(NL)
			.append("\t\tisNotNull();").append(NL)
			.append("\t\tdateAssert(\"").append(columnName).append("\", actual.get").append(columnName).append("(), expected);").append(NL)
			.append("\t\treturn myself;").append(NL)
			.append("\t}").append(NL)
			.append(NL)
			;
		...
		else
		{
			...
			if (clazz.equals(BigDecimal.class))
			{
				...
				.append("\t{").append(NL)
				.append("\t\tisNotNull();").append(NL)
				.append("\t\tbdAssert(\"").append(columnName).append("\", actual.get").append(columnName).append("(), expected);").append(NL)
				.append("\t\treturn myself;").append(NL)
				.append("\t}").append(NL)
				.append(NL)
				;
	...
	/**
	 * @param sourceFolder root folder where the generated assertions will be written.
	 *                     The assertions package path will be relative to this base.
	 * @param modelPackageName package where the existing generated models live.
	 * @param assertionsPackageName package where the newly-generated assertions will be written.
	 * @param entityType filter for the type of entities that will have assertions generated.
	 * @param tableLike SQL LIKE filter for the DB tables whose models will have assertions generated.
	 */
	public static void generateSource(String sourceFolder, String modelPackageName, String assertionsPackageName, String entityType, String tableName)
	{
	...
	static void writeAssertionsEntryPoint(String directory, String modelPackageName, String assertionsPackageName) {
		if ( ! directory.endsWith(File.separator) )
			directory += File.separator;
		...
		StringBuilder sb = new StringBuilder()
			.append (ModelInterfaceGenerator.COPY)
			.append ("/** Generated Assertion Class - DO NOT CHANGE */").append(NL)
			.append("package ").append(assertionsPackageName).append(";").append(NL)
			.append(NL)
		...
		//	Class
		sb
			.append("/** Generated assertions entry point").append(NL)
			.append(" *  @author iDempiere (generated) ").append(NL)
			.append(" *  @version ").append(Adempiere.MAIN_VERSION).append(" - $Id$ */").append(NL)
			.append("@Generated(\"").append(ModelAssertionGenerator.class).append("\")").append(NL)
			.append("public class IDAssertions {").append(NL)
			.append("\tprivate IDAssertions() {}").append(NL)
			.append(NL)
			;

		// Soft Assertions class.
		softSB
			.append("/** Generated soft assertions entry point").append(NL)
			.append(" *  @author iDempiere (generated) ").append(NL)
			.append(" *  @version ").append(Adempiere.MAIN_VERSION).append(" - $Id$ */").append(NL)
			.append("@Generated(\"").append(ModelAssertionGenerator.class).append("\")").append(NL)
			...
			for (int i = 0; i < last; i++) {
				...
				sb
				.append(NL)
				.append("\tpublic static ").append(assertion).append(" assertThat(").append(model).append(" a) {").append(NL)
				.append("\t\treturn new ").append(assertion).append("(a);").append(NL)
				.append("\t}").append(NL);
